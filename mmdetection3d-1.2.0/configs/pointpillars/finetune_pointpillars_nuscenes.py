...
data_root = '/home/asaad/Documents/2024/FDSNet/mmdetection3d-1.2.0/data/nuscenes'
...
load_from = '/home/asaad/Documents/2024/FDSNet/mmdetection3d-1.2.0/checkpoints/hv_pointpillars_secfpn_sbn-all_4x8_2x_nus-3d_20210826_225857-f19d00a3.pth'
log_level = 'INFO'
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=
        '/home/asaad/Documents/2024/FDSNet/mmdetection3d-1.2.0/data/nuscenes',
        metainfo=dict(classes=[
            'car',
            'truck',
            'trailer',
...
test_evaluator = dict(
    ann_file=
    '/home/asaad/Documents/2024/FDSNet/mmdetection3d-1.2.0/data/nuscenes/nuscenes_infos_val.pkl',
    data_root=
    '/home/asaad/Documents/2024/FDSNet/mmdetection3d-1.2.0/data/nuscenes',
    format_only=False,
    metric='bbox',
...
train_cfg = dict(max_epochs=50, type='EpochBasedTrainLoop', val_interval=24)
...
visualizer = dict(
    ...
    vis_backends=[
        dict(type='LocalVisBackend'),
        dict(save_dir='./FDSNet5', type='TensorboardVisBackend'),
    ])
voxel_size = [
    0.25,
    0.25,
